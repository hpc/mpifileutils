...
man_pages = [
    ...
    ('dfind.1', 'dfind', u'distributed file find program',[author], 1),
    ('dgrep.1', 'dgrep', u'distributed file content search program',[author], 1),
    ('dparallel.1', 'dparallel', u'execute command(s) in parallel',[author], 1),
    ('drm.1', 'drm', u'distributed remove',[author], 1),
    ('dstripe.1', 'dstripe', u'restripe files on underlying storage',[author], 1),
    ('dtar.1', 'dtar', u'distributed tape archine program',[author], 1),
