...
file system, and will split large file copies across multiple threads.
...
.. option:: -b, --blocksize SIZE
   ...
   Set the I/O buffer to be SIZE Mebibytes (MiB). Default 1 MiB.
...
.. option:: -k, --chunksize SIZE
   ...
   Split large files into chunks of SIZE Mebibytes (MiB) to be processed. 
   Multiple process ranks may copy a large file in parallel. Default 1 MiB.
