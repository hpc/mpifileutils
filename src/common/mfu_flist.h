...
int mfu_flist_copy(
    ...
    mfu_file_t* mfu_src_file,       /* IN  - I/O filesystem funcstions to use for copy of src */
    mfu_file_t* mfu_dst_file        /* IN  - I/O filesystem funcstions to use for copy of dst */
);
